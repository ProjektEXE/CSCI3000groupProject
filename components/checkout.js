window.addEventListener("DOMContentLoaded", () => {
    ...
    checkoutForm.addEventListener("submit", function (e) {
      ...
      if (!validateTextField(country, "Country")) isValid = false;
      if (!validateTextField(city, "City")) isValid = false;
      if (!validateTextField(state, "State/Province")) isValid = false;
      if (!validateTextField(cardName, "Cardholder name")) isValid = false;
